...
const TABLE_HEAD = [
  ...
  { id: 'appointment_status', label: 'Appointment Status', alignRight: false },
  { id: 'verification_status', label: 'Verification Status', alignRight: false },
  { id: '' },
];
...
export default function UserPage() {
  ...
  return (
    <>
      <Helmet>
        <title> Patients | Minimal UI </title>
      </Helmet>
